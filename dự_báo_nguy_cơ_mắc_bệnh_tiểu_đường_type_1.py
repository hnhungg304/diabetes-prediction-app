# -*- coding: utf-8 -*-
"""DỰ BÁO NGUY CƠ MẮC BỆNH TIỂU ĐƯỜNG TYPE 1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vfLbYf_RhT_LTj6lZAx839yR9mJyfZ8D
"""
...
# (import pandas as pd)
data = pd.read_csv(r"C:\Users\BINH\Documents\MyApp\data\diabetes_dataset.csv")
data.head()
...
# Chia biến X và Y
X = data.drop('Output', axis=1)   # Đặc trưng đầu vào
Y = data['Output']                # Nhãn đầu ra
...
# Lưu mô hình
joblib.dump(model,  r"C:\Users\BINH\Documents\MyApp\random_forest_diabetes_model.joblib")

# Tải mô hình
loaded_model = joblib.load( r"C:\Users\BINH\Documents\MyApp\random_forest_diabetes_model.joblib")